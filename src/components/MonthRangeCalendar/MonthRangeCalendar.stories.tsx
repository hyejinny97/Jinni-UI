import './MonthRangeCalendarCustom.scss';
...
const meta: Meta<typeof MonthRangeCalendar> = {
  title:
    'components/DateRangePicker/DateRangeCalendar/HDateMonthRangeCalendar/MonthRangeCalendar',
...
export default meta;
type Story = StoryObj<typeof MonthRangeCalendar>;
    ...
    disabledDates:
      ...
      ({ date, rangeField }) => {
        if (rangeField === 'end' && value.start) {
          const start = value.start.getMonth();
          const month = date.getMonth();
          return month < start || start + 2 < month;
        }
        return false;
      }
  }
...
export const BasicMonthRangeCalendar: Story = {
  render: (args) => <MonthRangeCalendar displayedDate={new Date()} {...args} />,
  parameters: {
    docs: {
      source: {
        code: `<MonthRangeCalendar displayedDate={new Date()} />`.trim()
      }
    }
  }
};
...
export const Locale: Story = {
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <MonthRangeCalendar key={locale} displayedDate={new Date()} locale={locale} />
    </Stack>
  );
};`.trim()
      }
...
export const ReadOnly: Story = {
  render: (args) => (
    <MonthRangeCalendar displayedDate={new Date()} readOnly {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<MonthRangeCalendar displayedDate={new Date()} readOnly />`.trim()
      }
    }
  }
};
...
export const Disabled: Story = {
  render: (args) => (
    <MonthRangeCalendar displayedDate={new Date()} disabled {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<MonthRangeCalendar displayedDate={new Date()} disabled />`.trim()
      }
    }
  }
};
