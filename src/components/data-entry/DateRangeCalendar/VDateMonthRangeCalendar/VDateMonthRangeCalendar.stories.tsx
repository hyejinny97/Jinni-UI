import './VDateMonthRangeCalendarCustom.scss';
...
export default meta;
type Story = StoryObj<typeof VDateMonthRangeCalendar>;
...
const ControlledVDateMonthRangeCalendarTemplate = () => {
  ...
  return (
    <Stack spacing={20}>
      ...
      <VDateMonthRangeCalendar value={value} onChange={handleChange} />
    </Stack>
  );
};
...
const LocaleTemplate = () => {
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <VDateMonthRangeCalendar key={locale} locale={locale} />
    </Stack>
  );
};

const OptionsTemplate = () => {
  const OPTIONS: Array<VDateMonthRangeCalendarProps['options']> = [
    { dateStyle: 'medium' },
    { year: 'numeric' },
    { year: '2-digit' }
  ] as const;
  const [option, setOption] = useState<VDateMonthRangeCalendarProps['options']>(
    OPTIONS[0]
  );

  const handleOptionChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const { value } = event.target;
    setOption(JSON.parse(value) as VDateMonthRangeCalendarProps['options']);
  };
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <VDateMonthRangeCalendar key={JSON.stringify(option)} options={option} />
    </Stack>
  );
};
...
const CountOfCalendarsTemplate = () => {
  type calendarsType = NonNullable<
    VDateMonthRangeCalendarProps['monthCalendars']
  >;
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <VDateMonthRangeCalendar monthCalendars={calendars} />
    </Stack>
  );
};

export const BasicVDateMonthRangeCalendar: Story = {
  render: (args) => (
    <Stack spacing={20}>
      <VDateMonthRangeCalendar {...args} />
...
export const ControlledVDateMonthRangeCalendar: Story = {
  render: () => <ControlledVDateMonthRangeCalendarTemplate />,
  parameters: {
    docs: {
      source: {
        code: `const ControlledVDateMonthRangeCalendarTemplate = () => {
  const [value, setValue] = useState<RangeType<Date | null>>({
    start: null,
    end: null
  });
...
export const ChooseInitialDate: Story = {
  render: (args) => (
    <VDateMonthRangeCalendar referenceDate={new Date(2000, 1, 1)} {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<VDateMonthRangeCalendar referenceDate={new Date(2000, 1, 1)} />`.trim()
      }
    }
  }
};
...
export const ReadOnly: Story = {
  render: (args) => <VDateMonthRangeCalendar readOnly {...args} />,
  parameters: {
    docs: {
      source: {
        code: `<VDateMonthRangeCalendar readOnly />`.trim()
      }
    }
  }
};
...
export const Disabled: Story = {
  render: (args) => <VDateMonthRangeCalendar disabled {...args} />,
  parameters: {
    docs: {
      source: {
        code: `<VDateMonthRangeCalendar disabled />`.trim()
      }
    }
  }
};
...
export const CustomRangeMonth: Story = {
  render: (args) => (
    <VDateMonthRangeCalendar className="custom-range-month" {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<VDateMonthRangeCalendar className="custom-range-month" />`.trim()
      }
    }
  }
};
