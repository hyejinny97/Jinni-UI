import './HDateDayRangeCalendarCustom.scss';
...
export default meta;
type Story = StoryObj<typeof HDateDayRangeCalendar>;
...
const ControlledHDateDayRangeCalendarTemplate = () => {
  ...
  return (
    <Stack spacing={20}>
      ...
      <HDateDayRangeCalendar value={value} onChange={handleChange} />
    </Stack>
  );
};
...
const LocaleTemplate = () => {
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <HDateDayRangeCalendar key={locale} locale={locale} />
    </Stack>
  );
};

const OptionsTemplate = () => {
  const OPTIONS: Array<HDateDayRangeCalendarProps['options']> = [
    { dateStyle: 'medium' },
    { dateStyle: 'short' },
    {
      year: 'numeric',
  ...
  const [option, setOption] = useState<HDateDayRangeCalendarProps['options']>(
    OPTIONS[0]
  );

  const handleOptionChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const { value } = event.target;
    setOption(JSON.parse(value) as HDateDayRangeCalendarProps['options']);
  };
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <HDateDayRangeCalendar key={JSON.stringify(option)} options={option} />
    </Stack>
  );
};

const CountOfCalendarsTemplate = () => {
  type calendarsType = NonNullable<HDateDayRangeCalendarProps['dayCalendars']>;
  ...
  return (
    <Stack spacing={20} style={{ alignItems: 'center' }}>
      ...
      <HDateDayRangeCalendar dayCalendars={calendars} />
    </Stack>
  );
};

export const BasicHDateDayRangeCalendar: Story = {
  render: (args) => (
    <Stack spacing={20}>
      <HDateDayRangeCalendar {...args} />
...
export const ControlledHDateDayRangeCalendar: Story = {
  render: () => <ControlledHDateDayRangeCalendarTemplate />,
  parameters: {
    docs: {
      source: {
        code: `const ControlledHDateDayRangeCalendarTemplate = () => {
  const [value, setValue] = useState<RangeType<Date | null>>({
    start: null,
    end: null
  });
...
export const ChooseInitialDate: Story = {
  render: (args) => (
    <HDateDayRangeCalendar referenceDate={new Date(2000, 1, 1)} {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<HDateDayRangeCalendar referenceDate={new Date(2000, 1, 1)} />`.trim()
      }
    }
  }
};
...
export const ReadOnly: Story = {
  render: (args) => <HDateDayRangeCalendar readOnly {...args} />,
  parameters: {
    docs: {
      source: {
        code: `<HDateDayRangeCalendar readOnly />`.trim()
      }
    }
  }
};
...
export const Disabled: Story = {
  render: (args) => <HDateDayRangeCalendar disabled {...args} />,
  parameters: {
    docs: {
      source: {
        code: `<HDateDayRangeCalendar disabled />`.trim()
      }
    }
  }
};
...
export const CountOfCalendars: Story = {
  ...
  type calendarsType = NonNullable<
    HDateDayRangeCalendarProps['dayCalendars']
  >;
  const CALENDARS: Array<calendarsType> = [1, 2, 3] as const;
  const [calendars, setCalendars] = useState<calendarsType>(2);
...
export const DisplayWeekNumber: Story = {
  render: (args) => <HDateDayRangeCalendar displayWeekNumber {...args} />
};

export const CustomRangeDay: Story = {
  render: (args) => (
    <HDateDayRangeCalendar className="custom-range-day" {...args} />
  ),
  parameters: {
    docs: {
      source: {
        code: `<HDateDayRangeCalendar className="custom-range-day" />`.trim()
      }
    }
  }
};
