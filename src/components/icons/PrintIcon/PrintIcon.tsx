...
export interface PrintIconProps extends React.HTMLAttributes<SVGElement> {
  size?: number;
  color?: ColorType;
}

const PrintIcon = ({ size = 24, color = 'black', ...rest }: PrintIconProps) => {
