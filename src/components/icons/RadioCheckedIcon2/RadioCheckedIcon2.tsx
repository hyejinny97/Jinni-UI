...
interface RadioCheckedIcon2Props extends React.HTMLAttributes<SVGElement> {
  size?: number;
  color?: ColorType;
}

const RadioCheckedIcon2 = ({
  size = 24,
  color = 'black',
  ...rest
}: RadioCheckedIcon2Props) => {
...
export default RadioCheckedIcon2;
