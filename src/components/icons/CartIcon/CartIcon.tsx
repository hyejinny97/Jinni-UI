...
export interface CartIconProps extends React.HTMLAttributes<SVGElement> {
  size?: number;
  color?: ColorType;
}

const CartIcon = ({ size = 24, color = 'black', ...rest }: CartIconProps) => {
